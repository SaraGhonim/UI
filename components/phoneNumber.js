...
<> 
  <View style={{marginBottom:20}}>
    ...
    fontWeight: '600',}}>Phone Number</Text>
   ...
   <TouchableOpacity style={styles.buttonContainer2} onPress={this._code}>
   <Text style={{textAlign:'center',  paddingTop:5,color:'white'}}>Verify</Text>
  </TouchableOpacity>  
